...
export const ShareCard = forwardRef<HTMLDivElement, ShareCardProps>(
  ({ playerName, totalScore, correctAnswers, totalQuestions, leaderboardPosition }, ref) => {
				...
				>
					...
					<div className="relative z-10 h-full flex flex-col justify-between p-8">
						...
						<div className="text-center">
							...
							<p className="text-orange-200 text-sm font-semibold">Music Quiz Challenge</p>
						</div>

						{/* Player & Score Section */}
						<div className="text-center">
							<div className="mb-6">
								<p className="text-orange-200 text-xs mb-1 tracking-wider">CHALLENGE
									COMPLETED BY</p>
								<h2 className="text-3xl font-bold">{playerName.toUpperCase()}</h2>
								{leaderboardPosition && (
							...
							<div className="bg-white/20 backdrop-blur-sm rounded-3xl p-8 mb-6">
								<div className="text-center">
									<div className="text-6xl font-bold mb-2 leading-none">{totalScore}</div>
							...
							<div className="grid grid-cols-2 gap-4">
								<div className="bg-white/15 backdrop-blur-sm rounded-xl p-3 text-center">
									...
									<div className="text-xl font-bold mb-0.5">{correctAnswers}/{totalQuestions}</div>
						...
						<div className="text-center">
							<div className="flex items-center justify-center gap-2 mb-2">
								...
								<span className="text-lg font-semibold">Powered by Musixmatch</span>
							</div>
							<p className="text-orange-200 text-xs">Test your music knowledge •
								musixmatch.com/quiz</p>
						</div>
					</div>
				</div>
			</div>
