import { getPopularTracks, getTrackSnippet, generateQuizQuestions } from '../musixmatch'
import { 
  mockTracksResponse, 
  mockSnippetResponse, 
...
describe('Musixmatch Service', () => {
  ...
  describe('getPopularTracks', () => {
    ...
    it('should handle HTTP errors', async () => {
      ...
      await expect(getPopularTracks()).rejects.toThrow('HTTP error! status: 500')
    })
    ...
    it('should handle API errors', async () => {
      ...
      await expect(getPopularTracks()).rejects.toThrow('Musixmatch API Error: Invalid API key')
    })
  })
  ...
  describe('getTrackSnippet', () => {
    it('should fetch and return snippet correctly', async () => {
      ...
      expect(result).toBe("I'm in love with the shape of you\nWe push and pull like a magnet do\nAlthough my heart is falling too\nI'm in love with your body")
    })
  ...
  describe('generateQuizQuestions', () => {
    ...
    it('should throw error when no tracks available', async () => {
      ...
      await expect(generateQuizQuestions(1)).rejects.toThrow('Not enough tracks available')
    })
    ...
    it('should throw error when no valid questions generated', async () => {
      ...
      await expect(generateQuizQuestions(1)).rejects.toThrow('Could not generate any quiz questions')
    })
